...
##        print("self.lights_by_id: " + str(self.lights_by_id))
##        print("self.lights_by_name: " + str(self.lights_by_name))
##        print("self.sensors_by_id : " + str(self.sensors_by_id))
##        print("self.sensors_by_name: " + str(self.sensors_by_name)) 
